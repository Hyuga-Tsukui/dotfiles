# Generated by Powerlevel10k configuration wizard on 2024-09-04 at 15:46 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=254
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=197
  ...
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_CONFIGURATION//\%/%%} ${P9K_GCLOUD_ACCOUNT//\%/%%} ${P9K_GCLOUD_PROJECT_NAME//\%/%%}'
